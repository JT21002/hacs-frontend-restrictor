// Restrictor Card — v0.15.1 (hotfix)
// Base stable (équivalent v0.10.1) : pas d’API layout custom, rien qui touche le gabarit
// - Overlay injecté dans chaque <ha-card> descendant (stacks OK)
// - Overlay OFF en mode édition
